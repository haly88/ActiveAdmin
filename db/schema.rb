...
ActiveRecord::Schema.define(version: 20160307210153) do
  ...
  add_index "physicians", ["address_id"], name: "index_physicians_on_address_id", using: :btree
  ...
  add_index "practices", ["address_id"], name: "index_practices_on_address_id", using: :btree
  ...
  add_foreign_key "physicians", "addresses"
  add_foreign_key "practices", "addresses"

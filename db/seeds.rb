...
Practice.create!(:id => 1, :name => 'Practice1', :address_id => 1, :price => 1)
Practice.create!(:id => 2, :name => 'Practice2', :address_id => 2, :price => 2)
Practice.create!(:id => 3, :name => 'Practice3', :address_id => 3, :price => 3)
Practice.create!(:id => 4, :name => 'Practice4', :address_id => 4, :price => 4)
Practice.create!(:id => 5, :name => 'Practice5', :address_id => 5, :price => 5)
Practice.create!(:id => 6, :name => 'Practice6', :price => 6)
Practice.create!(:id => 7, :name => 'Practice7', :address_id => 7, :price => 7)